...
const STATUS_VARIANTS: Record<InvoiceStatus, "success" | "warning" | "default" | "danger"> = {
  PAID:      "success",
  SENT:      "warning",
  DRAFT:     "default",
  CANCELLED: "danger",
            ...
            {items.map((item, i) => {
              ...
              return (
                <tr key={item.id} className="border-b border-gray-200">
                  ...
                  <td className="px-2 py-2 text-right tabular-nums">{fmt(item.rate)}</td>
                  ...
                  <td className="px-2 py-2 text-right tabular-nums font-medium">{fmt(amt)}</td>
                </tr>
              );
            })}
